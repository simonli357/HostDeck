...
- Current state: audit only. Android's official accessibility guidance requires swiping through elements, checking spoken feedback and reachability, and completing workflows with TalkBack; its documented next/previous and activation gestures are one-finger swipes and double-tap-anywhere. The existing code does none of those. A physical observation spike is pending because the phone is not USB-visible.
