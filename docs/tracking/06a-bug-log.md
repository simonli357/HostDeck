...
- Validation: parser regression covers AC/USB/wireless, inactive, invalid, contradictory, and oversized observations. Focused Android-driver tests pass 46 with one intentional physical skip and typecheck passes. The bounded-observation correction requires commit/push and one fresh clean aggregate run before this bug can close.
