...
| 3 | `DAT-V1-103` Native storage parity | in_progress | none | Remove the POSIX-only durable-cwd assumption, implement validated backup/restore, and prove migration/restore crash atomicity on both native targets. |
