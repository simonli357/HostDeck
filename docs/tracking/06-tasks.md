...
| 49 | `IFC-V1-090` Harden API/CLI startup, write path, service controls, LAN behavior, and failure surfaces | ready | none | Unblocked by `IFC-V1-014`; API/CLI module hardening can now inspect the completed interface foundation. |
| 50 | `REL-V1-002` Update developer guide setup after runtime/service facts are validated | ready | none | Unblocked by `IFC-V1-012`; final setup/service docs can now be tightened from observed foreground service behavior. |
