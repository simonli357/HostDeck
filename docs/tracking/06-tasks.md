...
| --- | --- | --- | --- | --- |
| 1 | `IFC-V1-038` Run aggregate fanout, health, reconnect, and shutdown acceptance | ready | none | Fanout, health, shutdown, and focused aggregate SSE overload hardening are complete. |
