...
| 44 | `IFC-V1-007` CLI session commands: `start`, `list`, `send`, `attach`, `stop`, and status display | ready | none | Next ready CLI leaf; unblocked by the CLI shell/API client foundation from `IFC-V1-006`. |
