...
| `BLK-V1-02` Local State / Auth / Audit | In progress | Storage implementation not started. | `artifacts/dat-v1-001-sqlite-driver-spike.md`, `artifacts/dat-v1-002-token-transport-spike.md`, `artifacts/dat-v1-003-retention-caps-spike.md` |
