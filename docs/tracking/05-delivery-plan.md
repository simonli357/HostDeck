...
- Current pass: Storage-owned local state/auth/audit, tmux fake adapter foundation, pairing/security API route foundation, and validation wiring complete; real tmux/startup-dependent work remains blocked
