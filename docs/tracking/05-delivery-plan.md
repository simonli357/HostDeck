...
| `BLK-V1-04` API / CLI Control Plane | In progress | Streams, write dispatch/audit ordering, CLI, service controls, network smoke, and hardening remain planned; stream route contracts are ready next. | `artifacts/ifc-v1-001-startup-readiness.md`, `artifacts/ifc-v1-002-read-routes.md`, `artifacts/ifc-v1-005-security-routes.md` |
