...
- Next exit: `FE-V1-010` implements the selected Focus Rail phone shell and two-route navigation, establishing the base for typed clients and screen groups.
...
| `BLK-V1-05` Mobile dashboard | Structured phone-state contract, two replacement directions, and human-selected Focus Rail targets pass. | Product UI, browser/accessibility/fidelity, and real-device evidence remain. | `FE-V1-010` to `FE-V1-040`, `FE-V1-090` |
...
| Mobile visual selection/UI/device | In progress | `FE-V1-004`, `FE-V1-002`, and `FE-V1-003` are complete with Focus Rail selected; implementation remains `FE-V1-010` to `FE-V1-040` and `FE-V1-090`. |
