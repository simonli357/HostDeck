...
| `BLK-V1-04` API / CLI Control Plane | In progress | CLI pairing/lock/LAN commands, service controls, interface hardening, and remaining negative failure coverage remain planned. | `artifacts/ifc-v1-001-startup-readiness.md`, `artifacts/ifc-v1-002-read-routes.md`, `artifacts/ifc-v1-003-stream-routes.md`, `artifacts/ifc-v1-004-write-routes.md`, `artifacts/ifc-v1-005-security-routes.md`, `artifacts/ifc-v1-006-cli-shell.md`, `artifacts/ifc-v1-007-cli-session-commands.md`, `artifacts/ifc-v1-010-api-route-contracts.md`, `artifacts/ifc-v1-011-network-smoke.md` |
