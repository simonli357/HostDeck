...
- Next exit: `IFC-V1-035` bounded subscriber ownership and `IFC-V1-036` mutable local/remote health advance the production interface toward shutdown and aggregate acceptance.
