...
- Current pass: Storage-owned local state/auth/audit, tmux fake adapter foundation, tmux output-capture spike, real tmux target primitives, pairing/security API route foundation, and validation wiring complete; managed Codex session start is next
...
| `BLK-V1-03` Tmux Session / Output | In progress | Codex start, send/stop/attach, output reader, restart service integration, real smoke, and hardening remain planned. | `artifacts/int-v1-001-tmux-capture-spike.md`, `artifacts/int-v1-010-fake-tmux-adapter.md`, `artifacts/int-v1-011-real-tmux-targets.md` |
