...
- Next exit: human `FE-V1-003` selects exact phone-first visual targets, unlocking the UI chain that produces the real assets required before `IFC-V1-053` and `IFC-V1-056`.
