...
| `BLK-V1-04` API / CLI Control Plane | In progress | Sessions, streams, write dispatch/audit ordering, CLI, service controls, network smoke, and hardening remain planned; route contracts are ready next. | `artifacts/ifc-v1-001-startup-readiness.md`, `artifacts/ifc-v1-005-security-routes.md` |
