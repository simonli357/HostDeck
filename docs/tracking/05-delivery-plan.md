...
| `BLK-V1-04` API/CLI/security/service | Typed Fastify/SSE/static/lifecycle boundaries and bounded commit-only projection fanout pass over the historical headless/CLI base. | Replay/live queues, HTTPS/security, health/routes, legacy disposition, enforced bounds, build, and services remain. | `IFC-V1-015` to `IFC-V1-069`, `IFC-V1-091` |
