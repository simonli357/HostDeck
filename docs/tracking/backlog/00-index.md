...
| Completed `FE-V1-003`, `IFC-V1-046`, and `FE-V1-010` shell | Ready `FE-V1-019`, then `FE-V1-023` to `FE-V1-025` | The implemented shell uses selected Focus Rail targets; typed clients now consume the assembled API. |
