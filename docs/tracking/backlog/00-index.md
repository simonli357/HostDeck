...
| `DAT-V1-019`, `DAT-V1-025`, `IFC-V1-024`, `IFC-V1-025`, `IFC-V1-038`, `IFC-V1-046`, `IFC-V1-052`, `IFC-V1-067` | `IFC-V1-021`, `IFC-V1-054`, and `IFC-V1-080` to `IFC-V1-085` are complete; `IFC-V1-086` adds the packaged service-owned HostDeck process before `IFC-V1-055`; `IFC-V1-053` and `IFC-V1-055` then feed `IFC-V1-056` to `IFC-V1-058` | Deterministic outputs now include the selected grammar, API/local commands, resources, application, foreground lifecycle, and executable. The service-owned process entry must precede truthful units; real assets, unit policy, service lifecycle, uninstall, and clean parity remain separate leaves. |
