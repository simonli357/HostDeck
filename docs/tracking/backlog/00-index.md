...
| `DAT-V1-019`, `DAT-V1-025`, `IFC-V1-024`, `IFC-V1-025`, `IFC-V1-038`, `IFC-V1-046`, `IFC-V1-052`, `IFC-V1-067` | `IFC-V1-021`, `IFC-V1-054`, `IFC-V1-055`, and `IFC-V1-080` to `IFC-V1-086` are complete; selected Focus Rail targets now unlock `FE-V1-010` and the UI/assets chain before `IFC-V1-053` and `IFC-V1-056` to `IFC-V1-058` | Deterministic outputs now include the selected grammar, API/local commands, resources, application, foreground/service lifecycles, executable, and exact user units. Real assets, persistent service lifecycle/install, uninstall, and clean parity remain separate leaves. |
...
| Completed `FE-V1-003` plus `IFC-V1-046` | `FE-V1-010`, `FE-V1-019`, then `FE-V1-023` to `FE-V1-025` | The shell uses selected Focus Rail targets; typed clients consume the assembled API. |
