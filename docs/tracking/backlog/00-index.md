...
| `DAT-V1-019`, `DAT-V1-025`, `IFC-V1-024`, `IFC-V1-025`, `IFC-V1-038`, `IFC-V1-046`, `IFC-V1-052`, `IFC-V1-067` | `IFC-V1-021`, `IFC-V1-054`, `IFC-V1-080` to `IFC-V1-086` are complete; ready `IFC-V1-055` owns user units; `IFC-V1-053` and `IFC-V1-055` then feed `IFC-V1-056` to `IFC-V1-058` | Deterministic outputs now include the selected grammar, API/local commands, resources, application, foreground lifecycle, executable, and independently restartable service process. Real assets, unit policy, service lifecycle, uninstall, and clean parity remain separate leaves. |
