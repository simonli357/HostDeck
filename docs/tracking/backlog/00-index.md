...
| Completed `FE-V1-003`, `IFC-V1-046`, `FE-V1-010`, and bounded JSON client `FE-V1-019` | Ready `FE-V1-023` and `FE-V1-024`, then `FE-V1-025` | The implemented shell and exact JSON transport use selected contracts; SSE continuity and in-memory CSRF complete the coordinated-client prerequisites. |
