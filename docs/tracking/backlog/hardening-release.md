...
| `REL-V1-003` | todo | `BLK-V1-06`, `FR-011`, `PR-008`, `IFC-V1-006` to `IFC-V1-008` | none | `IFC-V1-008` | `REL-V1-006` | Update command reference after CLI commands are runnable. | Command reference includes only copy-paste commands that have been run or marked as explicit gaps in release artifacts. | Command smoke output and command-reference diff. |
