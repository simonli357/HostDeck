...
- `IFC-V1-020` defines one strict resource policy across HTTP, SSE, admission, protocol, lifecycle, and CLI boundaries; `INT-V1-017`, `INT-V1-019` to `INT-V1-021` extend it to 67 fields with pending-notification, model/collaboration-catalog, pending model/Plan, and uncertain-goal ceilings. Stable oversized/overload codes, exact Fastify/Codex mappings, and monotonic deadline forms pass. Evidence: `artifacts/ifc-v1-020-resource-budget-deadline.md`, `artifacts/int-v1-017-codex-event-normalization.md`, `artifacts/int-v1-019-pending-model-control.md`, `artifacts/int-v1-020-goal-control.md`, `artifacts/int-v1-021-plan-control.md`.
