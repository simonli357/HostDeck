...
- Active task: `DAT-V1-018` selected mapping/projection/compatibility migration.
- Other ready tasks: `INT-V1-003`, `DAT-V1-019`, `IFC-V1-016`, and `IFC-V1-015`.
...
- Complete `DAT-V1-018` transactional selected mapping/projection migration and repository evidence.
...
- `FND-V1-015` is pushed as `f0da007`; `FND-V1-016` is pushed as `b497f66`; the current `FND-V1-091` completion unit is pending commit/push.
- Next action: complete `DAT-V1-018`, then advance the first ready dependency-aware selected-runtime task.
