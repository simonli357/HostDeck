...
- Active task: `IFC-V1-111` shared-session API/CLI and production composition.
...
- Validation: automatic enrollment passed focused 36, full unit 3,276, contract 307, integration 36, static gates, and two exact-Codex real runs with ordinary TUI roots loaded before and created after HostDeck. API/UI composition remains.
- Git: implementation is isolated and pushed through INT-V1-113 on `feat/shared-codex-runtime`; the primary dirty worktree remains untouched.
