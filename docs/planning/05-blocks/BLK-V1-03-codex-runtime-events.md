...
| Model, goal, plan, usage, compact, and skills ports | `INT-V1-019` to `INT-V1-024` | Model, goal, Plan, and generation-aware read-only usage are done; compact and skills remain. |
