...
| Crash reconciliation, HostDeck restart, and TUI coexistence | `INT-V1-029` to `INT-V1-031` | In progress: `INT-V1-029` and `INT-V1-030` are complete with durable crash and exact multi-process HostDeck-restart evidence; `INT-V1-031` remains ready for real TUI-coexistence proof. |
