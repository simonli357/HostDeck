...
| Storage foundation | `DAT-V1-010` to `DAT-V1-017` | In progress: `DAT-V1-010` done; `DAT-V1-011` to `DAT-V1-015` ready | `artifacts/dat-v1-010-sqlite-migration-runner.md`, `docs/tracking/backlog/local-state-auth-audit.md` |
