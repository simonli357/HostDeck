...
| --- | --- | --- | --- |
| Tmux capture spike and adapter foundation | `INT-V1-001`, `INT-V1-010` to `INT-V1-013` | In progress: `INT-V1-001`, `INT-V1-010`, `INT-V1-011`, and `INT-V1-012` done; send/stop/attach next | `artifacts/int-v1-001-tmux-capture-spike.md`, `artifacts/int-v1-010-fake-tmux-adapter.md`, `artifacts/int-v1-011-real-tmux-targets.md`, `artifacts/int-v1-012-real-tmux-start.md`, `docs/tracking/backlog/tmux-output.md` |
