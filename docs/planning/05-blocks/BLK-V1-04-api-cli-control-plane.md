...
| CLI surface and service controls | `IFC-V1-006` to `IFC-V1-014` | CLI shell/API client, CLI session commands, CLI pairing/lock/LAN commands, and localhost/LAN network smoke done; service smoke and full CLI command matrix remain planned | `artifacts/ifc-v1-006-cli-shell.md`; `artifacts/ifc-v1-007-cli-session-commands.md`; `artifacts/ifc-v1-008-cli-admin-commands.md`; `artifacts/ifc-v1-011-network-smoke.md`; `docs/tracking/backlog/api-cli-control-plane.md` |
