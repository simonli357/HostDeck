...
| Exact route-manifest contract | `IFC-V1-019` | In progress; replaces the historical 17-route tmux surface with one strict 36-route selected `/api/v1` inventory before route implementation. |
