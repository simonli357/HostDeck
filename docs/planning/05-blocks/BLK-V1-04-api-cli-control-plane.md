...
| Built assets, CLI binary, service-owned process, user units, lifecycle commands, uninstall, and clean parity | `IFC-V1-053` to `IFC-V1-058`, `IFC-V1-086` | The CLI binary and independently restartable packaged service process are complete. User units are ready; remaining work stays dependency-ordered behind production outputs and frontend readiness. |
