...
| Reopened interface hardening | `IFC-V1-091` | Ready: compatibility diagnostics and the package/service chain through clean supported-user parity are complete. Aggregate hardening remains; direct-LAN evidence is not a gate. |
