...
| Deterministic production-output foundation | `IFC-V1-021` | Ready: selected runtime, stream, route composition, static boundary, resource aggregate, legacy isolation, and bounded source-CLI inputs are accepted. |
