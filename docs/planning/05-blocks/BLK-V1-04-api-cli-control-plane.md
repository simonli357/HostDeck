...
| Built assets, CLI binary, service-owned process, user units, lifecycle commands, uninstall, and clean parity | `IFC-V1-053` to `IFC-V1-058`, `IFC-V1-086` | The real manifest-verified dashboard assets, CLI binary, independently restartable packaged service process, and exact runtime-proven user units are complete. Persistent install/lifecycle/uninstall/parity remains dependency-ordered through `IFC-V1-056` to `IFC-V1-058`. |
