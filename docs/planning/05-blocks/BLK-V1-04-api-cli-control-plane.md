...
| Replay/live, subscriber bounds, mutable health, shutdown, and aggregate stream matrix | `IFC-V1-034` to `IFC-V1-038` | High-water handoff is in progress; later leaves remain dependency-ordered behind it, runtime lifecycle, and data maintenance. |
