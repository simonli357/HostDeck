...
| --- | --- | --- | --- |
| Server startup and route contracts | `IFC-V1-001` to `IFC-V1-003`, `IFC-V1-010` | Ready to start: `IFC-V1-001` is unblocked; later route/stream contract tasks remain planned | `docs/tracking/backlog/api-cli-control-plane.md` |
