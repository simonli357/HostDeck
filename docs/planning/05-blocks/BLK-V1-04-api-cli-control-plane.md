...
| CLI surface and service controls | `IFC-V1-006` to `IFC-V1-014` | CLI shell/API client and localhost/LAN network smoke done; `IFC-V1-007`, `IFC-V1-008`, and `IFC-V1-012` are ready; remaining CLI/service tasks remain planned | `artifacts/ifc-v1-006-cli-shell.md`; `artifacts/ifc-v1-011-network-smoke.md`; `docs/tracking/backlog/api-cli-control-plane.md` |
