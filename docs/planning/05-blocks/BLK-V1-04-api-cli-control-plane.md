...
| Typed app, SSE adapter, static boundary, and listener lifecycle | `IFC-V1-022` to `IFC-V1-025` | Typed app and bounded SSE transport complete; static boundary in progress, followed by real-listener lifecycle. |
