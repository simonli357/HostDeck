...
| Transport/Host/Origin/CORS security foundation | `IFC-V1-017` | In progress; strict policy, hook ordering, hostile request, CORS denial, diagnostics, and raw-listener criteria are frozen. |
