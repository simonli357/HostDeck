...
| Write pipeline and trust routes | `IFC-V1-004`, `IFC-V1-005`, `IFC-V1-014` | Security routes, headless write route pipeline, and write rejection/failure-path integration coverage done; hardening remains planned | `artifacts/ifc-v1-004-write-routes.md`; `artifacts/ifc-v1-005-security-routes.md`; `artifacts/ifc-v1-014-write-rejection-integration.md`. |
| CLI surface and service controls | `IFC-V1-006` to `IFC-V1-014` | CLI shell/API client, CLI session commands, CLI pairing/lock/LAN commands, foreground service smoke, localhost/LAN network smoke, full CLI command matrix, and integration command wiring done; hardening remains planned | `artifacts/ifc-v1-006-cli-shell.md`; `artifacts/ifc-v1-007-cli-session-commands.md`; `artifacts/ifc-v1-008-cli-admin-commands.md`; `artifacts/ifc-v1-012-service-mode-smoke.md`; `artifacts/ifc-v1-011-network-smoke.md`; `artifacts/ifc-v1-013-cli-command-contracts.md`; `artifacts/ifc-v1-014-write-rejection-integration.md`; `docs/tracking/backlog/api-cli-control-plane.md` |
