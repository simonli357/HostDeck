...
| Tailscale contract spike and remote ingress path | `IFC-V1-070` to `IFC-V1-079` | Spike first; then observer, Serve ownership, proxy trust, source/rate composition, route rebaseline, remote CLI/API, QR pairing, lifecycle, hostile matrix, and physical cellular/profile-switch proof. |
