...
| `BLK-V1-03` | Tmux artifacts `INT-V1-001`, `INT-V1-010` to `INT-V1-016`, `INT-V1-090`. | `INT-V1-002` to `INT-V1-008`, `INT-V1-017` to `INT-V1-032`, `INT-V1-091`; real Codex operations and TUI/restart evidence. | L2/L3 | In progress; exact compatibility, IPC, managed-thread lifecycle, operation semantics, and ordered event projection pass; controls, supervision, restart, and legacy disposition remain. |
