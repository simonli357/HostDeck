...
| `BLK-V1-03` | Tmux artifacts `INT-V1-001`, `INT-V1-010` to `INT-V1-016`, `INT-V1-090`. | `INT-V1-002` to `INT-V1-008`, `INT-V1-017` to `INT-V1-032`, `INT-V1-091`; real Codex operations and TUI/restart evidence. | L2/L3 | Complete; `artifacts/int-v1-091-selected-runtime-hardening.md` and its clean-commit machine evidence close selected runtime behavior, failure matrices, privacy, and cleanup. |
| `BLK-V1-04` | `IFC-V1-001` to `IFC-V1-032`, `IFC-V1-034`, `IFC-V1-047`, `IFC-V1-090`, prior headless/Fastify/direct-LAN artifacts. | `IFC-V1-035`, `IFC-V1-070` to `IFC-V1-079`, remaining production-interface leaves, and `IFC-V1-091`; loopback/Tailscale/SSE/security/routes/resources/package/service proof. | L2/L3/L4 | Reopened; exact remote contracts/storage, observer, Serve ownership, proxy/source trust, application authorization, route manifest, remote control, fragment-safe physical Android pairing, mutable health, production remote lifecycle/SSE, aggregate hostile/phone acceptance, bounded selected SSE ownership, full route composition, bounded source-CLI transport, and aggregate resource stress pass. Package/service leaves and interface hardening remain. |
| `BLK-V1-05` | `FE-V1-001` fixture helpers and rejected legacy boards. | Completed `FE-V1-002` to `FE-V1-004`, shell `FE-V1-010`, Mission Control `FE-V1-011`, structured Session Detail `FE-V1-012`, fragment-safe pairing/host access `FE-V1-013`, bounded browser clients `FE-V1-019`/`FE-V1-023`/`FE-V1-024`, and coordinator `FE-V1-025`; remaining implementation `FE-V1-014` to `FE-V1-018`, `FE-V1-020` to `FE-V1-022`, `FE-V1-026` to `FE-V1-040`, and `FE-V1-090`. | L1/L3/L4 | Reopened; Focus Rail, production shell/runtime, exact coordinated clients, inventory/detail screens, and fragment-safe pairing/access with physical phone evidence are implemented, but actions, downstream trust/recovery, packaged assets, and complete-dashboard accessibility/fidelity remain. |
