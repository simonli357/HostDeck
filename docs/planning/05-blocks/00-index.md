...
| `BLK-V1-05` | `FE-V1-001` fixture helpers and rejected legacy boards. | Completed `FE-V1-004`, `FE-V1-002`, `FE-V1-003`, and shell foundation `FE-V1-010`; remaining implementation `FE-V1-019`, `FE-V1-011` to `FE-V1-040`, plus `FE-V1-090`, including remote/profile states. | L1/L3/L4 | Reopened; Focus Rail and the production source shell are implemented, but typed clients, real screens/actions, packaged assets, accessibility/fidelity, and device evidence remain. |
