...
| `BLK-V1-02` | `DAT-V1-001` to `DAT-V1-017`, `DAT-V1-090`, prior storage artifacts. | `DAT-V1-018` to `DAT-V1-030`, `DAT-V1-091`; production append/retention/audit/auth and permission/lease proof. | L1/L2/L3 inspection | Reopened; selected mapping, append/retention, secure paths/lease, and accepted-to-terminal audit state pass, while startup maintenance, orphan reconciliation, and auth lifecycle remain. |
| `BLK-V1-03` | Tmux artifacts `INT-V1-001`, `INT-V1-010` to `INT-V1-016`, `INT-V1-090`. | `INT-V1-002` to `INT-V1-008`, `INT-V1-017` to `INT-V1-032`, `INT-V1-091`; real Codex operations and TUI/restart evidence. | L2/L3 | In progress; exact compatibility, IPC, managed-thread lifecycle, operation semantics, ordered event projection, prompt/model/goal/Plan/usage/approval/interrupt controls pass; compact, skills, assembly, supervision, restart, and legacy disposition remain. |
| `BLK-V1-04` | `IFC-V1-001` to `IFC-V1-014`, `IFC-V1-090`, prior headless/custom-listener artifacts. | `IFC-V1-015` to `IFC-V1-069`, `IFC-V1-091`; production Fastify/HTTPS/SSE/security/routes/resources/package/service proof. | L2/L3/L4 | Reopened; typed app/SSE/static/lifecycle, commit-only fanout, and headless replay-to-live continuity pass, while sustained queues, selected routes/security, packaging, and LAN remain. |
