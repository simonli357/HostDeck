...
| `BLK-V1-04` | `IFC-V1-001` to `IFC-V1-032`, `IFC-V1-034`, `IFC-V1-047`, `IFC-V1-090`, prior headless/Fastify/direct-LAN artifacts. | `IFC-V1-035`, `IFC-V1-070` to `IFC-V1-079`, `IFC-V1-087`, remaining production-interface leaves, and `IFC-V1-091`; loopback/Tailscale/SSE/security/routes/resources/package/service proof. | L2/L3/L4 | Reopened; selected remote/interface foundations pass, while `BUG-017` requires real Codex-version observation, diagnostic-ready incompatibility, durable disconnected sealing, and public compatibility truth before UI and interface hardening. Package/service leaves also remain. |
