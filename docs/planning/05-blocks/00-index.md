...
| `BLK-V1-03` | Historical tmux and exact 0.144.0 private-runtime/adoption evidence retained. | `INT-V1-110` to `INT-V1-114`; exact 0.147.0 binding, standard broker, automatic enrollment, ordinary TUI continuity, and hardening. | L2/L3 | Reopened. |
