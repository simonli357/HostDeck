...
| BLK-V1-02 | Local state, auth, audit, and config | Yes | `BLK-V1-02-local-state-auth-audit.md` | `DR-001` to `DR-010`, `SFR-001`, `SFR-002`, `SFR-004`, `SFR-006` to `SFR-008`, `PR-009` | `BLK-V1-01`, `SPK-ARCH-004`; `SPK-ARCH-002` resolved by `DEC-014`, `SPK-ARCH-003` resolved by `DEC-015` | `docs/tracking/backlog/local-state-auth-audit.md` | In progress |
