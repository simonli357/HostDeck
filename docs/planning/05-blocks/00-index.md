...
| --- | --- | --- | --- | --- | --- |
| `BLK-V1-01` Contracts, core, fixtures | Stable normalized contracts for native/public identity, automatic enrollment, shared broker state, catalog events, app-server operations, and remote ingress/access state. | `FR-002`, `FR-006` to `FR-009`, `FR-012` to `FR-021`, `NFR-003`, `NFR-005` to `NFR-007`, `SFR-005`, `SFR-010` to `SFR-012`, `SFR-015` | Shared-runtime rebaseline and exact 0.147.0 spike | `foundation.md` | Reopened |
| `BLK-V1-02` Local state, auth, audit | Durable native-UUID mappings/projections, idempotent enrollment, compatibility and remote-ingress state, production retention, CSRF/device lifecycle, audit outcomes, permissions, and one-daemon lease. | `FR-020`, `FR-021`, `DR-001` to `DR-011`, `NFR-008`, `NFR-010`, `NFR-011`, `NFR-013`, `PR-009`, `SFR-006`, `SFR-007`, `SFR-014` to `SFR-016` | `BLK-V1-01` | `local-state-auth-audit.md` | Reopened |
| `BLK-V1-03` Codex runtime and events | Exact 0.147.0 standard shared broker, version/schema gate, automatic loaded-thread enrollment, bounded history, real turn/control/approval/events, ordinary TUI start/resume, restart/multi-client behavior, and legacy disposition. | `FR-001`, `FR-003` to `FR-009`, `FR-013` to `FR-021`, `NFR-002`, `NFR-012`, `PR-001`, `PR-006`, `PR-010` | `BLK-V1-01`, storage mapping work | `tmux-output.md` | Complete |
...
| `BLK-V1-07` Ubuntu distribution | Native Ubuntu paths, standard Codex transport, independent broker/HostDeck lifecycle, package, signature policy, updates, rollback, publication, and clean-host evidence. | `NFR-009`, `NFR-013`, `NFR-014`, `PR-001`, `PR-002`, `PR-007` to `PR-010`, `PR-012` to `PR-018`, `SFR-015` | Shared behavior in `BLK-V1-01` to `BLK-V1-05` | `cross-platform-distribution.md` | Reopened |

## Completion Matrix

| Block | Historical evidence retained | New blocking evidence | Minimum level | Status |
| --- | --- | --- | --- | --- |
| `BLK-V1-01` | Prior foundation plus completed adoption contracts remain reusable/historical. | `FND-V1-103`; native/public identity, enrollment, shared-broker, catalog, and pending-buffer contracts. | L1/L2 | Reopened. |
| `BLK-V1-02` | Prior selected storage plus `DAT-V1-105` adoption storage remains migration-compatible. | `DAT-V1-106`; native-UUID lookup and idempotent automatic-enrollment state. | L1/L2/L3 inspection | Reopened. |
| `BLK-V1-03` | Historical tmux and exact 0.144.0 private-runtime/adoption evidence retained. | `INT-V1-110` to `INT-V1-114`; exact 0.147.0 binding, standard broker, automatic enrollment, ordinary TUI continuity, and clean-commit hardening evidence. | L3 | Complete for the selected Ubuntu V1 runtime; distribution and release gates remain in `BLK-V1-05` to `BLK-V1-07`. |
...
| `BLK-V1-07` | Current Linux package/service/clean-user evidence and completed Windows groundwork are retained. | `IFC-V1-113`, `REL-V1-110`; standard-broker Ubuntu package/lifecycle and clean-host release acceptance. | L1/L2/L3/L4 native | Reopened; Windows is deferred to V2. |
...
| Native distribution gate | `BLK-V1-07` contracts, Ubuntu package/lifecycle, clean host, signature-policy and publication evidence | Ubuntu aggregate release validation. |
| Shared session interoperability | `REL-V1-109`, `INT-V1-110`, `FND-V1-103`, `DAT-V1-106`, `INT-V1-111` to `INT-V1-114`, `IFC-V1-111`, `IFC-V1-112`, `FE-V1-107` | Ordinary Codex and HostDeck phone use one broker/thread without transcript copy, adoption, or handoff ceremony. |
