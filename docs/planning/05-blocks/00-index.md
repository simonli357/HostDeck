...
| --- | --- | --- | --- | --- | --- | --- |
| BLK-V1-01 | Stable typed contracts, core state model, errors, write eligibility, and Codex-like fixtures exist before adapters/UI. | `FND-V1-001` to `FND-V1-013` in `foundation.md`. | Unit and contract test artifacts for models, schemas, errors, write gates, and fixture classification. | Fixture review proving unknown/failure states are not treated as healthy success. | Blocks all implementation work that consumes contracts. | In progress: `FND-V1-001` to `FND-V1-009`, `FND-V1-012`, and `FND-V1-013` done |
