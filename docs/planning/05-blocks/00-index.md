...
| --- | --- | --- | --- | --- |
| `BLK-V1-01` | `FND-V1-001` to `FND-V1-017`, `FND-V1-091`, prior foundation artifacts. | `FND-V1-018`, `FND-V1-092`; remote-ingress/access contracts, fixtures, public exports, adoption, and focused hardening. | L1/L2 | Reopened; structured-runtime evidence remains valid, but the selected remote-access contract outcome is not implemented. |
| `BLK-V1-02` | `DAT-V1-001` to `DAT-V1-030`, `DAT-V1-090`, `DAT-V1-091`, prior storage artifacts. | `DAT-V1-031`, `DAT-V1-032`, `DAT-V1-092`; remote configuration/audit migration, preservation, privacy, restart, and focused hardening. | L1/L2/L3 inspection | Reopened; existing storage evidence remains valid, but selected remote-ingress durability is missing. |
| `BLK-V1-03` | Tmux artifacts `INT-V1-001`, `INT-V1-010` to `INT-V1-016`, `INT-V1-090`. | `INT-V1-002` to `INT-V1-008`, `INT-V1-017` to `INT-V1-032`, `INT-V1-091`; real Codex operations and TUI/restart evidence. | L2/L3 | In progress; the exact structured control/approval/two-thread vertical passes, while production supervision, restart/reconciliation, multi-client completion, legacy disposition, and module hardening remain. |
| `BLK-V1-04` | `IFC-V1-001` to `IFC-V1-032`, `IFC-V1-034`, `IFC-V1-047`, `IFC-V1-090`, prior headless/Fastify/direct-LAN artifacts. | `IFC-V1-070` to `IFC-V1-079`, remaining production-interface leaves, and `IFC-V1-091`; loopback/Tailscale/SSE/security/routes/resources/package/service proof. | L2/L3/L4 | Reopened; direct-LAN/custom-CA evidence is historical, and the selected remote path is unimplemented. |
