...
| `BLK-V1-04` | `IFC-V1-001` to `IFC-V1-032`, `IFC-V1-034`, `IFC-V1-047`, `IFC-V1-053` to `IFC-V1-055`, `IFC-V1-070` to `IFC-V1-079`, `IFC-V1-086`, `IFC-V1-087`, `IFC-V1-090`, and prior headless/Fastify/direct-LAN artifacts. | `IFC-V1-056` to `IFC-V1-058` and `IFC-V1-091`; persistent lifecycle/install/parity and aggregate interface hardening. | L2/L3/L4 | Reopened; selected remote/interface foundations, real compatibility diagnostics, deterministic server/CLI plus dashboard package, executable/service process, and exact user units pass. Persistent install/parity and aggregate interface hardening still block completion. |
| `BLK-V1-05` | `FE-V1-001` fixture helpers and rejected legacy boards. | Completed `FE-V1-002` to `FE-V1-004`, `FE-V1-010` to `FE-V1-016`, `FE-V1-019` to `FE-V1-040`, and `IFC-V1-053`; remaining `FE-V1-017`, `FE-V1-018`, and `FE-V1-090`. | L1/L3/L4 | Reopened; Focus Rail, the complete production dashboard behavior, packaged assets, responsive layout, semantic accessibility, focused physical phone evidence, and exact Chromium/Firefox phone/desktop package coverage pass. Visual fidelity, copy/workflow review, and aggregate phone module acceptance remain. |
