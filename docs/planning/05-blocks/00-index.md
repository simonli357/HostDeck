...
| `BLK-V1-05` | `FE-V1-001` fixture helpers and rejected legacy boards. | Completed `FE-V1-004`, `FE-V1-002`, `FE-V1-003`, shell `FE-V1-010`, and bounded JSON client `FE-V1-019`; remaining implementation `FE-V1-011` to `FE-V1-040`, plus `FE-V1-090`, including SSE/CSRF/coordinated remote-profile state. | L1/L3/L4 | Reopened; Focus Rail, production source shell, and exact JSON transport are implemented, but coordinated clients, real screens/actions, packaged assets, accessibility/fidelity, and device evidence remain. |
