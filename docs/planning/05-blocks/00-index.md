...
| `BLK-V1-05` | `FE-V1-001` fixture helpers and rejected legacy boards. | Completed `FE-V1-004`, `FE-V1-002`, and `FE-V1-003`; implementation `FE-V1-010` to `FE-V1-040` plus `FE-V1-090`, including remote/profile states. | L1/L3/L4 | Reopened; Focus Rail is approved under `DEC-028`, but no production UI is implemented. |
