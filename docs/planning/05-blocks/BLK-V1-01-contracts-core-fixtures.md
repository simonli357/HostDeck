...
| Core model and contracts | `FND-V1-003` to `FND-V1-006`, `FND-V1-012`, `FND-V1-013` | In progress | `artifacts/fnd-v1-003-core-model.md`, `artifacts/fnd-v1-005-errors.md`, `docs/tracking/backlog/foundation.md` |
