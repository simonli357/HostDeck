...
6. Public errors and diagnostics retain only generic invalid-origin/error codes and bounded counters. Source hashes, generations, external origin values, Tailscale identity/profile/DNS fields, cookies, and raw tokens do not enter public authentication contexts, audit payloads, logs, or snapshots.
