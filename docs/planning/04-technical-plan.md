...
| UI | Exact React 19.2.8, React Router 8.2.0, Radix Dialog 1.1.20, Lucide React 1.25.0, Vite 8.1.4, and `@playwright/test` 1.61.1 after the visual-selection gate. | The Focus Rail two-route phone shell, strict session navigation, supporting sheet, component tests, and 390 x 844 browser captures are implemented. Typed clients, real screens/actions, packaged assets, broad responsive/accessibility coverage, and final fidelity remain downstream. |
