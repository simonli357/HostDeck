...
| NFR-010 | `BLK-V1-02` to `BLK-V1-04` | `DAT-V1-019`, `DAT-V1-024`, `DAT-V1-030`, `INT-V1-007`, `INT-V1-028` to `INT-V1-032`, `IFC-V1-025`, `IFC-V1-035` to `IFC-V1-038`, `IFC-V1-020`, `IFC-V1-047` to `IFC-V1-052`, `IFC-V1-071`, `IFC-V1-078`, `IFC-V1-086` | Ownership, lease, observer, timeout, and shutdown tests. |
