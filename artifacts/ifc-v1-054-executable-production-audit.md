...
- Current package input: the `IFC-V1-021` deterministic six-package runtime layout, mechanically expanded through `IFC-V1-081` to 606 sources and 1,219 owned outputs.
