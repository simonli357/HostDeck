...
| `SPC-11` | Prompt content, operation/audit/turn/runtime ids, CSRF/cookie values, private target data, and raw failures never enter rendered copy, URL/history, browser storage, console, screenshots, or persisted evidence. |
