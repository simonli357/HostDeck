...
export function renderHelp(): string {
  return [
    ...
    "  codexdeck devices [--limit N] [--cursor CURSOR] [--json]",
    "  codexdeck revoke DEVICE_ID --confirm [--json]",
    "  codexdeck lock [--json]",
    ...
    "  --state-dir PATH   Local HostDeck state directory for administrative commands.",
