...
export const resourceBudgetDefinitions = Object.freeze([
  ...
  defineResource("protocol_usage_max_daily_buckets", "count", 1, 2_000, 10_000, "codex_broker", "service_overloaded", "abort_operation"),
  defineResource("protocol_skills_max_entries_per_cwd", "count", 1, 256, 1_024, "codex_broker", "service_overloaded", "abort_operation"),
  defineResource("protocol_skills_max_errors_per_cwd", "count", 1, 64, 256, "codex_broker", "service_overloaded", "abort_operation"),
  defineResource("protocol_skills_max_dependencies_per_skill", "count", 1, 64, 256, "codex_broker", "service_overloaded", "abort_operation"),
  defineResource("protocol_collaboration_max_entries", "count", 2, 8, 32, "codex_broker", "service_overloaded", "abort_operation"),
  defineResource("control_prompt_max_tracked_turns", "count", 1, 128, 4_096, "turn_control", "service_overloaded", "reject_operation"),
  defineResource("control_interrupt_max_tracked_turns", "count", 1, 128, 4_096, "turn_control", "service_overloaded", "reject_operation"),
