  ...
  const capabilityState = state === "supported"
    ...
    : state === "version_drift" || state === "incompatible"
      ...
      : state === "degraded" && evidence === "current"
        ? "limited"
        : "unverified";
  const observedVersion = unobserved ? null : state === "version_drift" ? "0.145.0" : "0.144.0";
