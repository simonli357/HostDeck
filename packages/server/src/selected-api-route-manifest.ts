...
export const selectedApiSchemaIds = [
  ...
  "plan_selection_request_v1",
  "compact_start_request_v1",
  "approval_response_request_v1",
  "interrupt_request_v1",
  "archive_session_request_v1",
  "pair_request_v1",
  "pair_claim_v1",
...
export const selectedApiRouteManifest: readonly SelectedApiRouteManifestEntry[] = deepFreeze([
  ...
  route({
    ...
    transport: "json",
    request: request("session_id_params_v1", null, "archive_session_request_v1"),
  ...
  route({
    ...
    transport: "json",
    request: request("session_id_params_v1", null, "prompt_dispatch_request_v1"),
  ...
  route({
    ...
    path: "/api/v1/sessions/:session_id/model",
    transport: "json",
    request: request("session_id_params_v1", null, "model_selection_request_v1"),
    response: response("model_control_snapshot_v1"),
    ...sessionWritePolicy,
    target: "managed_session",
    operation_kind: "model",
  ...
  route({
    ...
    path: "/api/v1/sessions/:session_id/goal",
    transport: "json",
    request: request("session_id_params_v1", null, "goal_mutation_request_v1"),
    response: response("goal_control_snapshot_v1"),
    ...sessionWritePolicy,
    target: "managed_session",
    operation_kind: "goal",
  ...
  route({
    ...
    path: "/api/v1/sessions/:session_id/plan",
    transport: "json",
    request: request("session_id_params_v1", null, "plan_selection_request_v1"),
    response: response("plan_control_snapshot_v1"),
    ...sessionWritePolicy,
    target: "managed_session",
    operation_kind: "plan",
  ...
  route({
    ...
    path: "/api/v1/sessions/:session_id/compact",
    transport: "json",
    request: request("session_id_params_v1", null, "compact_start_request_v1"),
    response: response("compact_progress_response_v1"),
    ...sessionWritePolicy,
    target: "managed_session",
    operation_kind: "compact",
  ...
  route({
    ...
    transport: "json",
    request: request("session_approval_params_v1", null, "approval_response_request_v1"),
  ...
  route({
    ...
    transport: "json",
    request: request("session_turn_params_v1", null, "interrupt_request_v1"),
    response: response("interrupt_response_v1"),
    ...sessionWritePolicy,
    target: "turn",
