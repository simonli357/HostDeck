...
export const runtimeHardeningDeterministicTests = Object.freeze([
  ...
  "packages/codex-adapter/src/rotating-transport.test.ts",
  ...
  "packages/codex-adapter/src/tui-resume-platform.test.ts",
  ...
  "packages/server/src/codex-windows-runtime-connection.test.ts",
