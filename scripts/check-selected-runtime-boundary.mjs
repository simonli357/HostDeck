...
const exactRootModules = new Map([
  ...
  [
    ...
    [
      ...
      "./archive-control-state.js",
      "./archive-control.js",
      "./compact-control-state.js",
      "./compact-control.js",
      "./connection-state.js",
      "./csrf-client.js",
      "./event-diagnostics-state.js",
      "./event-diagnostics.js",
      "./goal-control-state.js",
      "./goal-control.js",
      "./host-access-recovery-state.js",
      "./host-access.js",
      "./host-lock-state.js",
      "./host-lock.js",
      "./http-client.js",
      "./http-route-contracts.js",
      "./interrupt-control-state.js",
      "./interrupt-control.js",
      "./laptop-resume-control-state.js",
      "./laptop-resume-control.js",
      "./model-control-state.js",
      "./model-control.js",
      "./paired-device-management-state.js",
      "./paired-device-management.js",
      "./plan-control-state.js",
      "./plan-control.js",
      "./pairing-bootstrap.js",
      "./pairing-screen.js",
      "./prompt-composer-state.js",
      "./prompt-composer.js",
      "./remote-connection-recovery-state.js",
      "./runtime-compatibility-state.js",
      "./runtime-compatibility.js",
      "./session-detail-feed.js",
      "./session-detail.js",
      "./session-utilities.js",
      "./skills-control-state.js",
      "./skills-control.js",
      "./sse-client.js",
      "./sse-route-contract.js",
      "./usage-control-state.js",
      "./usage-control.js"
    ]
  ],
  [
...
export const directHostApiOwnerPaths = Object.freeze([
  ...
  "packages/server/src/codex-windows-structured-vertical-report.ts",
...
function validateRootScripts(rootPackage, failures) {
  ...
  const expectedWebTest =
    "vitest run packages/web/src/accessibility-state.test.ts packages/web/src/app-shell.test.tsx packages/web/src/app-startup.test.ts packages/web/src/archive-control-state.test.ts packages/web/src/archive-control.test.tsx packages/web/src/approval-decision-state.test.ts packages/web/src/approval-decisions.test.tsx packages/web/src/browser-runtime.test.ts packages/web/src/compact-control-state.test.ts packages/web/src/compact-control.test.tsx packages/web/src/connection-state.test.ts packages/web/src/cross-screen-control-matrix.test.ts packages/web/src/cross-screen-failure-state.test.ts packages/web/src/csrf-client.test.ts packages/web/src/event-diagnostics-state.test.ts packages/web/src/event-diagnostics.test.tsx packages/web/src/host-access-recovery-state.test.ts packages/web/src/host-access.test.tsx packages/web/src/host-lock-state.test.ts packages/web/src/host-lock.test.tsx packages/web/src/http-client.test.ts packages/web/src/interrupt-control-state.test.ts packages/web/src/interrupt-control.test.tsx packages/web/src/laptop-resume-control-state.test.ts packages/web/src/laptop-resume-control.test.tsx packages/web/src/mission-control.test.tsx packages/web/src/mobile-copy-contract.test.ts packages/web/src/goal-control-state.test.ts packages/web/src/goal-control.test.tsx packages/web/src/model-control-state.test.ts packages/web/src/model-control.test.tsx packages/web/src/paired-device-management-state.test.ts packages/web/src/paired-device-management.test.tsx packages/web/src/pairing-bootstrap.test.ts packages/web/src/pairing-screen.test.tsx packages/web/src/plan-control-state.test.ts packages/web/src/plan-control.test.tsx packages/web/src/prompt-composer-state.test.ts packages/web/src/prompt-composer.test.tsx packages/web/src/remote-connection-recovery-state.test.ts packages/web/src/responsive-layout-state.test.ts packages/web/src/runtime-compatibility-state.test.ts packages/web/src/runtime-compatibility.test.tsx packages/web/src/session-catalog-state.test.ts packages/web/src/session-detail-feed.test.ts packages/web/src/session-detail.test.tsx packages/web/src/skills-control-state.test.ts packages/web/src/skills-control.test.tsx packages/web/src/sse-client.test.ts packages/web/src/usage-control-state.test.ts packages/web/src/usage-control.test.tsx packages/test-fixtures/src/accessibility-matrix.test.ts packages/test-fixtures/src/copy-workflow-matrix.test.ts packages/test-fixtures/src/fixtures.test.ts packages/test-fixtures/src/responsive-layout-matrix.test.ts";
  if (scripts["test:web"] !== expectedWebTest) {
    failures.push(
      "package.json test:web must run only selected accessibility, shell, startup, approval, archive control, browser-runtime, Compact control, connection-state, copy-workflow, cross-screen hardening, CSRF, event diagnostics, host/access/lock, HTTP, interrupt control, laptop resume control, Mission Control, goal control, model control, paired-device management, pairing, Plan control, prompt composer, remote recovery, responsive layout, runtime compatibility, session catalog, Session Detail, Skills control, SSE, Usage control, and fixture tests"
    );
  }
}
